...
HD_PWD='C:/Code/FPGA-HDL/Custom_IP/MotorDriver_v1_0/MotorDriver_V1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MotorDriver.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MotorDriver.tcl
